...
const Features = () => {
  ...
  return (
    <section style={darkMode ? {backgroundColor :"black", color:"white"} : {backgroundColor:"white", color:"black"}} className="text-foreground container max-w-screen-xl px-3 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
